...
`hot.md`, prepare the proposed operation with `source_agent: hermes` and use
`wiki-write-guard`. Hermes is an external observed system by default; do not
merge Hermes content into another agent's canonical truth without escalation.
