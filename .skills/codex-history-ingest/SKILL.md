...
Codex logs may contain system/developer prompts, tool payloads, secrets, and
telemetry; if the guard cannot classify the operation safely, queue it instead
of writing target files.
